...
public class Undecorator extends StackPane {
	...
	/**
	 * Init the minimum/pref/max sizes in order to be reflected in the primary
	 * stage
	 */
	...
	void loadConfig() {
		...
		try {
			prop.load(Undecorator.class.getClassLoader()
					.getResourceAsStream("com/testmydata/css/skin/undecorator.properties"));
		...
		LOC = ResourceBundle.getBundle("com/testmydata/fxutil/localization", Locale.getDefault());
